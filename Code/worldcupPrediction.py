...
'''
Comparing the predicted outcomes to the actual outcomes, I think that the prediction model did a pretty good job.
However, as stated earlier, soccer is hard to predict and Spain acutally did not make it this far in the tournament.
I still think that most of the games were precice, however, and the model worked well. 
'''